...
const Footer = () => {
  ...
  // Handles the submission of the email for the newsletter
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Newsletter subscription for:', email); // Prints the email to the console
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/" className="text-black hover:text-gray-900 font-poppins">Home</Link></li>
                <li><Link href="/about" className="text-black hover:text-gray-900 font-poppins">About us</Link></li>
                <li><Link href="/membership" className="text-black hover:text-gray-900 font-poppins">Membership</Link></li>
                <li><Link href="/contact" className="text-black hover:text-gray-900 font-poppins">Contact us</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/member" className="text-black hover:text-gray-900 font-poppins">Member</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/news" className="text-black hover:text-gray-900 font-poppins">OTM Outbound Travel Mart 2025</Link></li>
                <li><Link href="/news" className="text-black hover:text-gray-900 font-poppins">Phuket Roadshow to Middle East 2025</Link></li>
              </ul>
            </div>
